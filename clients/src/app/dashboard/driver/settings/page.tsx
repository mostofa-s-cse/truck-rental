...
export default function DriverSettingsPage() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      const mockSettings: DriverSettings = {
        account: {
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
                      ...
                      <div className="space-y-3">
                        <label className="flex items-center">
                          <input
                            ...
                            className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                          />
                          <span className="ml-2 text-sm text-gray-700">Share location with customers</span>
                        </label>
              ...
              {activeTab === 'preferences' && (
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Driver Preferences</h3>
                    <div className="space-y-4">
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={settings.preferences.autoAcceptBookings}
                          onChange={(e) => updateSettings('preferences', { autoAcceptBookings: e.target.checked })}
                          className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <span className="ml-2 text-sm text-gray-700">Auto-accept bookings within preferences</span>
                      </label>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            value={settings.preferences.minFare}
                            onChange={(e) => updateSettings('preferences', { minFare: parseInt(e.target.value) })}
                            className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateSettings('preferences', {
                              workingHours: { ...settings.preferences.workingHours, end: e.target.value }
                            })}
                            className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                          {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => (
                            <label key={day} className="flex items-center">
                              <input
                                type="checkbox"
                                checked={settings.preferences.daysOfWeek.includes(day)}
                                onChange={(e) => {
                                  const updatedDays = e.target.checked
                                    ? [...settings.preferences.daysOfWeek, day]
                                    : settings.preferences.daysOfWeek.filter(d => d !== day);
                                  updateSettings('preferences', { daysOfWeek: updatedDays });
                                }}
                                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                              />
