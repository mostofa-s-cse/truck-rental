  ...
  const fetchProfileData = useCallback(async () => {
    try {
      ...
      const mockProfile: AdminProfile = {
        ...
        bio: 'Experienced system administrator with expertise in managing truck booking platforms and ensuring smooth operations.',
        preferences: {
          emailNotifications: true,
          smsNotifications: false,
          pushNotifications: true,
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">{profile.stats.totalActions}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Login Count</span>
                    <span className="text-sm font-medium text-gray-900">{profile.stats.loginCount}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Last Action</span>
                    <span className="text-sm text-gray-900">{profile.stats.lastAction}</span>
                  </div>
                </div>
              </div>
